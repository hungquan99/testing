...
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/hungquan99/HungHubUI/main/Loading_UI')))()
local Window = OrionLib:MakeWindow({Name = "Skull Hub ", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Skull Hub "})
...
OrionLib:MakeNotification({
	Name = "Skull Hub ",
	Content = "Skull Hub  Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
